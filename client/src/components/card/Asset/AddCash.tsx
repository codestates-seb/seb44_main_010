...
export default function AddCash({ cashModal, setCashModal }: { cashModal: boolean; setCashModal: (value: boolean) => void; editing: boolean; setEditing: (value: boolean) => void }) {
